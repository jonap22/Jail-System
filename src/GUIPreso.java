...
public class GUIPreso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Sistema de busqueda"));

        jLabel1.setText("Cédula o Documento de identidad");
...
//        }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        // TODO add your handling code here:
        String identificativo = txtBusqueda.getText();
        int ident = Integer.parseInt(identificativo);
        for (Preso p : misPresos) {
            if (p.getDocumentodeindentidad() == ident) {
